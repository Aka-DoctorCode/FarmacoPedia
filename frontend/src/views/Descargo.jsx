			...
			<main id={Styles.descargo}>
				...
				<div id={Styles.principal}>
					...
					<p>
						...
						presente en el sitio web. Los usuarios de &#34;FarmacoPedia&#34; son
						responsables de verificar la información contenida en el sitio web
						con otras fuentes, antes de tomar cualquier decisión médica. Este
						descargo de responsabilidad se aplica a todo el contenido del sitio
						web, incluyendo, pero no limitado a, artículos, videos, imágenes, y
						otros materiales. Específicamente, el sitio web no se hace
						responsable de: Errores o inexactitudes en la información
						proporcionada. Daños o lesiones causadas por el uso de la
						información proporcionada. Cualquier acción tomada por un usuario
						del sitio web, basada en la información proporcionada. Los usuarios
						del sitio web son responsables de su propia salud y bienestar. Si
						tiene alguna pregunta o inquietud sobre su salud, debe consultar a
						un profesional de la salud. Fecha de vigencia: 22 de octubre de 2023
					</p>
					<div className={Styles.barra}></div>
					<p>
